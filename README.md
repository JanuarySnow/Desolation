...
I have further edited these mods with addons and custom changes so that bandits still spawn and various bosses and locations are to be found. And scattered villages have holdouts of resistance.

These factions and monsters will often fight each other, and can die and conquer without your presence. Scavenging their battle sites is a valiid strategy!

# Visuals

The visuals of this list use the latest Post-processing fork of Community Shaders, to desaturate, fade and fog up the visuals, with Hazy weathers

this gives it a faded, dreamlike, and gritty look, somewhat like old film.
It wont be everyones cup of tea, but I like it so it what it is :)

# Gameplay

This is a modlist with survival as a focus - it uses mods such as Campfire, Frostfall, Sunhelm, CC Fishing, Hunting Overhaul, Skills of the Wild all patched and customized. You will get cold and hungry. Most food has been removed from the world ( as its a post-apocalyptic Skyrim ) So hunting and foraging and scavenging is required to stay alive.
...
The game will start with you choosing a class, then exiting the Helgen cave and being teleported to Angis Camp where the story begins. Or you can choose the deeply unfair random location mod , where you will likely start right next to enemies, and have to run away to survive, fun!
...
The modlist is very difficult, but also it throws lots of loot at you, and time to kill enemies is reduced.
...
You can climb slopes with skyparkour, and paraglide with the paraglider mod!
...
This is the part of the list that I need the most feedback on, I have added various animations, third person camera, valravn and dodge mods and various other shield timed blocking and parrying mods, also skyvalor to change armor calculations to make the tiers more distinct.
...
DLSS and framegen are enabled by default, you can change this in the community shaders menu by pressing the END key
...
Requires 330GB total space, of which there is 130gb downloads
